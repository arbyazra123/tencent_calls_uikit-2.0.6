...
class CallState {
  ...
  TUICallObserver observer = TUICallObserver(
      ...
      onCallReceived: (String callerId, List<String> calleeIdList,
        ...
        CallState.instance.handleCallReceivedData(callerId, calleeIdList, groupId, callMediaType);
        if (!await TUICallKitPlatform.instance.isAppInForeground()) {
          ...
          CallManager.instance.launchCallWidget();
        }
      },
  ...
  void handleCallReceivedData(String callerId, List<String> calleeIdList,
      String groupId, TUICallMediaType callMediaType) async {
